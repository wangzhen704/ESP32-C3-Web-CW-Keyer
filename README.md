...
* **虚拟接地设计**：巧妙利用 GPIO 输出低电平作为回路地，简化硬件焊接难度。
...
4. **连接线**：3.5mm 音频线 (二芯或三芯均可，连接电台 KEY 口)。
5. **其他**：杜邦线、烙铁等。
...
| **GPIO 11** | 直连 | PC817 Pin 2 (阴极) | **虚拟地线 (Virtual GND)** |
| **PC817 Pin 4** | 直连 | 3.5mm 插头 **尖端 (Tip)** | 接电台正极 |
| **PC817 Pin 3** | 直连 | 3.5mm 插头 **根部 (Sleeve)** | 接电台地线 |

> **注意**：本项目使用 GPIO 11 输出低电平来模拟 GND，方便在开发板一侧排针上直接焊接，无需寻找公共地引脚。
